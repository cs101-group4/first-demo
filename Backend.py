...
class DemoRequestHandler(BaseHTTPRequestHandler):
    def query_helper(query):
        ...
        openai.api_key = key
        prompt = f"Response in the form of a json object in a single line. Extract the useful information that can be used on a calendar. Here's the given information:{query}"
